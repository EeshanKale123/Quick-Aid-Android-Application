...
public class DispListItems1 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
    	...
    	setContentView(R.layout.listdisp1);
		...
		public void onClick(View v) {
			...
			startActivity(i);
			MediaPlayer mp = MediaPlayer.create(DispListItems1.this, R.raw.mysound);   
            mp.start();
    	...
    	home.setOnClickListener(new OnClickListener()
    	{
    		public void onClick(View v)
    		{
    			Intent in=new Intent(DispListItems1.this, Service.class);
    			startActivity(in);
    			MediaPlayer mp = MediaPlayer.create(DispListItems1.this, R.raw.mysound);   
                mp.start();
                mp.setOnCompletionListener(new OnCompletionListener() {
    	...
    	back.setOnClickListener(new OnClickListener()
    	{
    		public void onClick(View v)
    		{
    			Intent in=new Intent(DispListItems1.this, Operation.class);
    			startActivity(in);
    			MediaPlayer mp = MediaPlayer.create(DispListItems1.this, R.raw.mysound);   
                mp.start();
                mp.setOnCompletionListener(new OnCompletionListener() {
		    ...
		    try{
		        	...
		        	mapbtn.setOnClickListener(new OnClickListener()
		        	{
		        		...
		        		{	
		        			...
		        			Intent in=new Intent(DispListItems1.this, MapOne.class);
		        			in.putExtras(b);
		        			startActivity(in);
		        			MediaPlayer mp = MediaPlayer.create(DispListItems1.this, R.raw.mysound);   
		                    mp.start();
		        	...
		        	send.setOnClickListener(new OnClickListener()
		        	{
		        		...
		        		{	
		        			...
		        			Intent in=new Intent(DispListItems1.this, Finish.class);
		        			in.putExtras(b);
		        			startActivity(in);
		        			MediaPlayer mp = MediaPlayer.create(DispListItems1.this, R.raw.mysound);   
		                    mp.start();
