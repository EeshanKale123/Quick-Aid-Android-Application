...
public class MyReviewAdapter extends ArrayAdapter<String> {
	...
	public MyReviewAdapter(Activity context, int[] idn, String[] name, double[] distance, String[] address , String[] Landmark, 
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.text.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					Intent intent = new Intent(v.getContext(), DispListItems.class);
					intent.putExtras(b);
